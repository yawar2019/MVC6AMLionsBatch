...
namespace ModelBasedApproach.Controllers
{
    public class EmployeeDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Designation")] EmployeeDetail employeeDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Designation")] EmployeeDetail employeeDetail)
        {
            if (ModelState.IsValid)
            {
